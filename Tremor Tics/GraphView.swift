...
public class GraphView: View {
    ...
    public func add(sample: Double) {
        metalGraph.add(sample: Float(sample))
    }
    ...
    private func addTitleAndSubtitleLabels() {
        ...
        titleLabel   .font = Font.systemFont(ofSize: 25)
        subtitleLabel.font = Font.systemFont(ofSize: 14)
        ...
        fileprivate func colors() -> [CGColor] {
            ...
            case .red:
                return [Color(red: 253.0/255.0, green:  58.0/255.0, blue:  52.0/255.0, alpha: 1.0).cgColor,
                        Color(red: 255.0/255.0, green: 99.0/255.0, blue:  80.0/255.0, alpha: 1.0).cgColor]
            case .green:
            ...
            case .blue:
                return [Color(red:  0.0/255.0,  green: 108.0/255.0, blue: 250.0/255.0, alpha: 1.0).cgColor,
                        Color(red: 30.0/255.0,  green: 165.0/255.0, blue: 251.0/255.0, alpha: 1.0).cgColor]
            case .turquoise:
            ...
            case .purple:
                return [Color(red: 140.0/255.0, green:  70.0/255.0, blue: 250.0/255.0, alpha: 1.0).cgColor,
                        Color(red: 191.0/255.0, green: 104.0/255.0, blue: 252.0/255.0, alpha: 1.0).cgColor]
            case .clear:
...
class RenderCycle {
    ...
    fileprivate func remove(cycleObserver: RenderCycleObserver) {
        pthread_mutex_lock(&mutex)
        if let idx = observers.firstIndex(where: { $0.value === cycleObserver }) {
